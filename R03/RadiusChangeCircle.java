 ...
 */
public class RadiusChangeCircle {
    ...
    /**
     * Create a RadiusChangeCircle with a given location and radius and with a
     * randomly selected, semi-transparent color.
     * @param x   The x coordinate of the center.
     * @param y   The y coordinate of the center.
     * @param radius       The radius of the circle.
     */
    public RadiusChangeCircle( double x, double y, int radius ) {
        this.x = x;
        this.y = y;
        this.radius = radius;
    ...
    public void draw( Graphics g ) {
		...
		/**
		    update the position of the RadiusChangeCircle after dt seconds
				@param dt the number of seconds for the update (e.g. 0.02)
		*/
		public void update(double dt){
			// change the properties of the RadiusChangeCircle after dt seconds have elapsed.
      ...
      if (this.radius <10) this.vr = -this.vr;
		...
		*/
        ...
        this.vx = -this.vx;
			...
			}else if (this.x > RadiusChangeCircle.boardWidth-this.radius) {
        ...
        this.vy = -this.vy;
			...
			} else if (this.y > RadiusChangeCircle.boardHeight-this.radius) {
